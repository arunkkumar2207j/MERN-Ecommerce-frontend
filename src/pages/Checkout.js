  ...
  return (
    ...
    <form className='bg-white px-5'>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 border-solid border-2">
          <div className="flex min-w-0 gap-x-4">
            <input type='radio' name="address" className='h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600' />
